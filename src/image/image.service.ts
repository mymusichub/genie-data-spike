...
export class ImageService {
  private readonly ALLOWED_FILE_MIME_TYPES = ['image/jpeg', 'image/png', 'image/gif'];
  ...
  async processAndAnalyzeImage(file: Express.Multer.File, prompt: string): Promise<ImageValidationResponse> {
